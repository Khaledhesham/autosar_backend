...
class DataTypeHFile:
    def __init__(self, file, swc):
        ...
        print("/*", end="", file=file)
        print("   Code generated by Autosar Studio for software Component:", end="", file=file)
        print("   " + swc.name, end="", file=file)
        print("*/", end="", file=file)
        print("", end="", file=file)
        print("#ifndef RTE_HEADER_Data_Type_h_", end="", file=file)
        print("#define RTE_HEADER_Data_Type_h_", end="", file=file)
        print("", end="", file=file)
        print("#include \"rtetypes.h\"", end="", file=file)
        print("", end="", file=file)
        print("/*", end="", file=file)
        print("   This file contains defintions for the DataTypes supported", end="", file=file)
        print("   by the Software Component (" + swc.name + ")", end="", file=file)
        print("*/", end="", file=file)
        print("", end="", file=file)

        for data_type in swc.datatype_set.all():
            print("typedef " + data_type_typedef[data_type.type] + " " + data_type.type, end="", file=file)

        print("", end="", file=file)
        print("#endif", end="", file=file)
...
class RteHFile:
    def __init__(self, file, swc):
        ...
        print("*/", end="", file=file)
        print("", end="", file=file)
        print("#ifndef RTE_HEADER_" + swc.name + "_h_", end="", file=file)
        print("#define RTE_HEADER_" + swc.name + "_h_", end="", file=file)
        print("", end="", file=file)
        print("#include \"datatypes.h\"", end="", file=file)
        print("", end="", file=file)
        print("/*", end="", file=file)
        print("   This file contains prototypes for the runnables and data access points", end="", file=file)
        print("   used by the Software Component (" + swc.name + ")", end="", file=file)
        print("*/", end="", file=file)
        print("", end="", file=file)
        ...
        for runnable in swc.runnable_set.all():
            for access in runnable.dataaccess_set.all():
                if access.type == "DATA-READ-ACCESSS":
                    print(data_type_typedef[access.data_element_ref.data_element.type.name] + " " + "Rte_IRead_" + swc.name + "_" + runnable.name + "_" + access.data_element_ref.port.name + "_" + access.data_element_ref.data_element.name + "(void);", end="", file=file)
                else:
                    print("void " + "Rte_IWrite_" + swc.name + "_" + runnable.name + "_" + access.data_element_ref.port.name + "_" + access.data_element_ref.data_element.name + "(" + data_type_typedef[access.data_element_ref.data_element.type.name] + "u);", end="", file=file)
 
                print("", end="", file=file)

        for runnable in swc.runnable_set.all():
            print("extern void " + runnable.name + "(void);", end="", file=file)
...
class RunnableCFile:
    def __init__(self, file, swc):
        ...
        print("   " + swc.name, end="", file=file)
        print("", end="", file=file)
        print("   This file should contain definitions for the runnables.", end="", file=file)
        print("   Prototypes for the runnable functions and data access methods", end="", file=file)
        print("", end="", file=file)
        print("   Example:", end="", file=file)
        print("   real_T Rte_IRead_swc_Runnable_Step_Port1_DataElement1();", end="", file=file)
        print("", end="", file=file)
        print("   extern void Runnable_Step(void);", end="", file=file)
        print("", end="", file=file)
        print("   Refer to" + swc.name + "_rte.h to find the current supported", end="", file=file)
        print("   function headers", end="", file=file)
        print("*/", end="", file=file)
        print("", end="", file=file)
        print(include, end="", file=file)
        print("", end="", file=file)
        print("/* WRITE YOUR CODE DOWN HERE */", end="", file=file)
        print("", end="", file=file)
...
class RunnableCompileFile:
    def __init__(self, file, runnable):
        ...
        for access in runnable.dataaccess_set.all():
            if access.type == "DATA-READ-ACCESSS":
                print(access.data_element_ref.data_element.type + " " + "Rte_IRead_" + runnable.swc.name + "_" + runnable.name + "_" + access.data_element_ref.port.name + "_" + access.data_element_ref.data_element.name + "(void)", end="", file=file)
                print("{", end="", file=file)
                print("    return " + access.data_element_ref.data_element.name + ";", end="", file=file)
                print("}", end="", file=file)
            else:
                print("void " + "Rte_IWrite_" + runnable.swc.name + "_" + runnable.name + "_" + access.data_element_ref.port.name + "_" + access.data_element_ref.data_element.name + "(" + access.data_element_ref.data_element.type + "u)", end="", file=file)
                print("{", end="", file=file)
                print("    " + access.data_element_ref.data_element.name + " = u;", end="", file=file)
                print("}", end="", file=file)

            print("", end="", file=file)

        print("int main()", end="", file=file)
        print("{", end="", file=file)

        for e in input_data_elements:
            print("    " + e.name + " = " + e.GetValue() + ";", end="", file=file)

        print("", end="", file=file)
        print("    " + runnable.name + "();", end="", file=file)
        print("", end="", file=file)

        print("    printf(\"{\")", end="", file=file)
