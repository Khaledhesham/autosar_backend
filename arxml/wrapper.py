...
class DataTypeHFile:
    def __init__(self, file, swc):
        ...
        print >> file, "/*"
        print >> file, "   Code generated by Autosar Studio for software Component:"
        print >> file, "   " + swc.name
        print >> file, "*/"
        print >> file, ""
        print >> file, "#ifndef RTE_HEADER_Data_Type_h_"
        print >> file, "#define RTE_HEADER_Data_Type_h_"
        print >> file, ""
        print >> file, "#include \"rtetypes.h\""
        print >> file, ""
        print >> file, "/*"
        print >> file, "   This file contains defintions for the DataTypes supported"
        print >> file, "   by the Software Component (" + swc.name + ")"
        print >> file, "*/"
        print >> file, ""

        for data_type in swc.datatype_set.all():
            print >> file, "typedef " + data_type_typedef[data_type.type] + " " + data_type.type
...
class RteHFile:
    def __init__(self, file, swc):
        ...
        print >> file, "*/"
        print >> file, ""
        print >> file, "#ifndef RTE_HEADER_" + swc.name + "_h_"
        print >> file, "#define RTE_HEADER_" + swc.name + "_h_"
        print >> file, ""
        print >> file, "#include \"datatypes.h\""
        print >> file, ""
        print >> file, "/*"
        print >> file, "   This file contains prototypes for the runnables and data access points"
        print >> file, "   used by the Software Component (" + swc.name + ")"
        print >> file, "*/"
        print >> file, ""
