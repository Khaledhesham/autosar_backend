...
class SoftwareComponent(models.Model):
    ...
    uid = models.CharField(max_length=20, default=str(guid.uuid1), unique=True)
    implementation_uid = models.CharField(max_length=20, default=str(guid.uuid1), unique=True)
    behavior_uid = models.CharField(max_length=20, default=str(guid.uuid1), unique=True)
    behavior_uid = models.CharField(max_length=20, default=str(guid.uuid1), unique=True)
    package_uid = models.CharField(max_length=20, default=str(guid.uuid1), unique=True)
    subpackage_uid = models.CharField(max_length=20, default=str(guid.uuid1), unique=True)
